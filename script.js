...
$( "#contactsTab" ).click(function() {
  ...
  console.log('for a good time call 1(415)-724-7250');
...
function renderProjectsTab(){
    ...
    <section>
      ...
      <a href="https://findmysound.herokuapp.com/"> Check it out!</a>
      <br>
     <a href="https://github.com/teddygallion/api-hack"><i class="fab fa-github"></i></a>
    </section>
    <section>
      ...
      <a href="projects/myMelody/index.html">Check it out!</a>
      <br>
      <a href="https://github.com/teddygallion/myMelody"><i class="fab fa-github"></i></a>
    </main>
  </section>
    ...
    <a href="projects/QuizApp/index.html"> Check it out! </a>
    <br/>
    <a href="https://github.com/teddygallion/quiz-app"><i class="fab fa-github"></i></a>
  </section>
    `
}
function renderContactTab(){
  ...
  <section id="contact-info">
    ...
    <a href ="https://linkedin.com/in/teddygallion"><i class="fab fa-linkedin"></i></a>
     <br/>
    <a href="https://github.com/teddygallion"><i class="fab fa-github"></i></a>
     <br/>
